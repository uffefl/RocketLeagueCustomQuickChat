...
Curses.Insert("My fucking ballache!")
Curses.Insert("Oh my bloody fucking shit!")
Curses.Insert("I'm such a shitting ballbreaker!")
Curses.Insert("Bloody fucking hell!")
Curses.Insert("Fucking balls!")
Curses.Insert("My cunting fuck!")
Curses.Insert("My cock!")
Curses.Insert("Bollocks!")
Curses.Insert("Bollocks to that!")
Curses.Insert("Oh my cocking shit!")
Curses.Insert("Up my arse!")
Curses.Insert("Piss!")
